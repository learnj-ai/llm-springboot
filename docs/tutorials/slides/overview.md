...
class: center, middle, authors-slide
...
### .emoji[🎯] Semantic Search Fundamentals
...
### .emoji[🔧] Connecting LLMs to the World
...
### .emoji[🏢] Taking LLMs to Production
